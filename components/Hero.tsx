...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Blob background */}
      <svg
        className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 w-[60vw] max-w-3xl opacity-60 pointer-events-none"
        viewBox="0 0 600 600"
